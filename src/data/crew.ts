...
const list: CrewDefinition[] = [
  {
    ...
    passiveDescription: 'Every attack you make deals +2 damage.',
    passive: { kind: 'calibration', amount: 2 },
    dialogues: [
  ...
  },
  {
    ...
    passiveDescription: 'Repair 6 hull after every fight you win.',
    passive: { kind: 'repairAfterCombat', amount: 6 },
    dialogues: [
  ...
  },
  {
    ...
    passiveDescription: '+1 reactor power every turn.',
    passive: { kind: 'power', amount: 1 },
    dialogues: [
  ...
  },
  {
    ...
    passiveDescription: 'The first damage you take each fight is nullified.',
    passive: { kind: 'evasion' },
    dialogues: [
  ...
  },
  {
    ...
    passiveDescription: 'Cards left in your hand are kept instead of discarded.',
    passive: { kind: 'retainHand' },
    dialogues: [
  ...
  },
  {
    ...
    passiveDescription: 'Start every fight with 10 shields.',
    passive: { kind: 'startingShield', amount: 10 },
    dialogues: [
...
/**
 * How many crew can be aboard at once. Offers keep coming once you are full — you
 * choose who to replace — so the cap shapes the run without closing the door on it.
 */
export const CREW_CAP = 3;
